...
filepath_700d = "../input/lst_700.csv"
filepath_750d = "../input/lst_750D.csv"
...
# Get unique ItemId for 750d
with open(filepath_750d) as csv750d:
	csv_opened = csv.DictReader(csv750d)
	itemID750d_all = []
	for row in csv_opened:
		if row["ItemID(LIsting_id)"] not in itemID750d_all and row["ItemID(LIsting_id)"] != "":
			itemID750d_all += [row["ItemID(LIsting_id)"]]
l_750d = len(itemID750d_all)
#print('l_750d:', l_750d)
...
# get each id's dict_yi_index when bundle_index = 1 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_1 = []
	for itemID in itemID750d_all:
		csvfile.seek(0)
		temp_dict_index = []
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "1" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_1 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_1))

# get each id's dict_yi_index when bundle_index = 2 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_2 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "2" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_2 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_2))


# get each id's dict_yi_index when bundle_index = 3 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_3 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "3" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_3 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_3))


# get each id's dict_yi_index when bundle_index = 4 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_4 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "4" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_4 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_4))


# get each id's dict_yi_index when bundle_index = 5 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_5 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "5" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_5 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_5))


# get each id's dict_yi_index when bundle_index = 6 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_6 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "6" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_6 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_6))


# get each id's dict_yi_index when bundle_index = 7 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_7 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "7" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_7 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_7))


# get each id's dict_yi_index when bundle_index = 8 in 750d
with open(filepath_750d) as csvfile:
	csv_opened = csv.DictReader(csvfile)
	dict_index750d_8 = []
	for itemID in itemID750d_all:
		...
		for row in csv_opened:
			if row["ItemID(LIsting_id)"] == itemID and row["bundle_index"] == "8" and row["dict_yi_index"] not in temp_dict_index:
				temp_dict_index += [row["dict_yi_index"]]
		dict_index750d_8 += [temp_dict_index]
#print('should be', l_750d, len(dict_index750d_8))
...
an = "Jiahao"
with open('../output/gen_700_750_output.csv', 'w') as csvfile:
		...
		for i in range(0,7):
			for j in range(i + 1, 8):
				for idx in range(0, l_750d):

					array = [dict_index750d_1, dict_index750d_2, dict_index750d_3, 
					dict_index750d_4, dict_index750d_5, dict_index750d_6, dict_index750d_7, dict_index750d_8]
					...
					if one != [] or other != []:
						o = comp_array(one, other)
						writer.writerow({'Author': an, 
							'ItemID(LIsting_id)': str(itemID750d_all[idx]), 
							'camera_model': "750d",
							'two_bundle_index': [i + 1, j + 1], 
							'deltaN': o[0], 
							'only_in_one': o[1], 
